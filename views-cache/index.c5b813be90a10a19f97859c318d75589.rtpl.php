<?php if(!class_exists('Rain\Tpl')){exit;}?>    <div class="slider-area">
        	<!-- Slider -->
			<div class="block-slider block-slider4" style="padding: 20px;">
				<ul class="" id="bxslider-home4">
					<?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?>
                    <li>
						<img src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="Slide" style="width: 400px; height: 400px; position: relative; left: 5%;">
						<div class="caption-group">
							<h2 class="caption title" style="font-size: 28px; color: red; position: relative; right: -20%;">
								<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
							</h2>
							<h4 class="caption subtitle" style="position: relative; right: -20%;">R$<?php echo formatPrice($value1["vlprice"]); ?></h4>
							<a class="caption button-radius" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" style="position: relative; right: -20%;"><span class="icon"></span>Comprar</a>
						</div>
					</li>
					<?php } ?>
				</ul>
